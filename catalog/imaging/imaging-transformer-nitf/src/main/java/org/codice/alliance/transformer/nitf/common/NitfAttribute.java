 ...
 * accessor function is used to extract an attribute value from the CommonNitfSegment that contains
 * it. This interface allows the transformer to access NitfAttributes in a generic way.
 *
...
public interface NitfAttribute<T> {
   ...
   * @throws org.codice.alliance.transformer.nitf.NitfParsingException when there is an error
   *     parsing the {@code NitfAttribute}
   */
