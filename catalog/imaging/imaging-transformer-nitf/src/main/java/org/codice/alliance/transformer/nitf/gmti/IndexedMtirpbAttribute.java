...
public class IndexedMtirpbAttribute extends NitfAttributeImpl<TreGroup> {
    ...
    private static final String INDEXED_TARGET_LOCATION = PREFIX + "target-location";

    private static final String INDEXED_TARGET_CLASSIFICATION_CATEGORY =
            PREFIX + "target-classification-category";

    private static final String INDEXED_TARGET_AMPLITUDE = PREFIX + "target-amplitude";

    private static final String INDEXED_TARGET_HEADING = PREFIX + "target-heading";

    private static final String INDEXED_TARGET_GROUND_SPEED = PREFIX + "target-ground-speed";

    private static final String INDEXED_TARGET_RADIAL_VELOCITY = PREFIX + "target-radial-velocity";

    private static final String INDEXED_TARGET_LOCATION_ACCURACY =
