...
public class MtirpbAttribute extends NitfAttributeImpl<Tre> {
    ...
    private static final String NUMBER_OF_VALID_TARGETS = PREFIX + "number-of-valid-targets";

    private static final String AIRCRAFT_LOCATION = PREFIX + "aircraft-location";

    private static final String AIRCRAFT_ALTITUDE = PREFIX + "aircraft-altitude";

    private static final String AIRCRAFT_ALTITUDE_UNITS = PREFIX + "aircraft-altitude-unit-of-measure";

    private static final String AIRCRAFT_HEADING = PREFIX + "aircraft-heading";

    private static final String COSINE_OF_GRAZE_ANGLE = PREFIX + "cosine-of-graze-angle";

    private static final String DESTINATION_POINT = PREFIX + "destination-point";

    private static final String MTI_LR = PREFIX + "mti-left-or-right";

    private static final String PATCH_NUMBER = PREFIX + "patch-number";

    private static final String SCAN_DATE_AND_TIME = PREFIX + "scan-date-and-time";

    private static final String SQUINT_ANGLE = PREFIX + "squint-angle";

    private static final String WIDE_AREA_MTI_FRAME_NUMBER = PREFIX + "wide-area-mti-frame-number";

    private static final String WIDE_AREA_MTI_BAR_NUMBER = PREFIX + "wide-area-mti-bar-number";
