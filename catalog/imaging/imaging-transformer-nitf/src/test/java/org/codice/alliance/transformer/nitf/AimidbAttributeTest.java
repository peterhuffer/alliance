...
public class AimidbAttributeTest {
    ...
    public void testCountryCode() throws NitfFormatException {
        when(tre.getFieldValue(AimidbAttribute.COUNTRY_ATTRIBUTE.getShortName())).thenReturn(FIPS_COUNTRY_CODE);

        String countryCode = (String) AimidbAttribute.COUNTRY_ATTRIBUTE.getAccessorFunction()
                .apply(tre);
